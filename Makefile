...
# Compiler's flags:
CFLAGS = -pg -g -I./ -I$(CUDA_PATH) -I$(CUDA_SHR_PATH) -I$(CUDA_SHR_PATH2) -L$(CUDA_LIB_PATH) -L$(CUDA_LIB_PATH2) -L$(CUDA_LIB_PATH3)  -lcuda -lcudart -lshrutil_x86_64 -lcublas -lm --ptxas-options=-v -gencode=arch=compute_20,code=sm_20 -gencode=arch=compute_13,code=sm_13 
